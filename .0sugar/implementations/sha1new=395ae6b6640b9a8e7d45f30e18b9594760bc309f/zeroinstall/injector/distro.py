...
class Distribution(object):
	...
	def get_package_info(self, package, factory):
		...
		@return: True if package implementations were added
		@rtype: bool
		"""
		return False
...
class CachedDistribution(Distribution):
	...
	def _write_cache(self, cache):
		...
		try:
			...
			leaf_path = os.path.join(self.cache_dir, self.cache_leaf)
			os.rename(tmpname, leaf_path)
			os.chmod(leaf_path, 0660)
		except:
			os.unlink(tmpname)
			raise
